                    ...
                    <asp:View ID="ViewInput" runat="server">
			                    ...
			                    <tr>
                                        ...
                                        <table width="100%" border="0" cellpadding="0" cellspacing="4">
			                                ...
			                                <tr>
				                                ...
				                                <td align="left" style="Width:70%;">
                                                    <asp:DropDownList ID="ddlType" runat="server" Width="262px">
                                                    </asp:DropDownList>
                                                </td>
			                                </tr>
			                                <tr>
				                                ...
				                                <td align="left">
                                                    ...
                                                    ValidationGroup="RegistrationValidationGroup"><img src="../../../App_Themes/Default/Images/Left_Arrow.png" 
				                    ...
				                    <td align="left" valign="top" style="width:50%;">
                                        <table width="100%" border="0" cellpadding="0" cellspacing="4">
			                                ...
			                                <tr>
				                                <td align="left" style="width:30%;">Cell : </td>
				                                <td align="left" style="Width:70%;">
                                                    <asp:TextBox ID="txtCell" runat="server" Width="258px"></asp:TextBox>
                                                </td>
			                                </tr>
			                                <tr>
				                                <td align="left" style="width:30%;">Email : </td>
				                                <td align="left" style="Width:70%;">
                        ...
                        <div class="feature-box-actionBar">
                            ...
                            <asp:Button ID="btnSave" runat="server" CssClass="button" Text="Save" 
                                ValidationGroup="RegistrationValidationGroup" OnClick="btnSave_Click" />
                        </div>
                    </asp:View>
                                ...
                                <tr>
                                    <td align="center">
                                        <span class="succesNotification">
                                            Registration Saved/Edited Successfully. <br />
                            ...
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td align="center" valign="middle">
                                        <span class="failureNotification">
                                            Error Occured Saving/Editing Registration<br />
                                            Dialog will Close automatically within 2 Seconds
                                        </span>
                                    </td>
                                </tr>
